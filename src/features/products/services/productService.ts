...
class ProductService extends BaseFirestoreService<Product> {
  ...
  protected override parse(data: any): Product {
    ...
    return {
      ...
      subCat: data.subCat || data.subcat || data.subCategory || data.scat || data.foodSubCategory || data.ecommerceSubCategory,
      subSubCat: data.subSubCat || data.subsubcat || data.subSubCategory || data.speccat || data.specCat || data.subSubCcat,
